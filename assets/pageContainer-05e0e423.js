...
import { _ as S } from './_plugin-vue_export-helper-3666fca8.js'
const w = u({
            ...
            e.$slots.header || e.header
              ? (n(),
                c(
                  ...
                  [r(e.$slots, 'header', {}, () => [y(_(e.header), 1)])],
                  2
                ))
              : h('v-if', !0),
            t(
              'div',
              {
                class: o([s(a).e('body'), e.bodyClass]),
                style: v(e.bodyStyle)
              },
              [r(e.$slots, 'default')],
              6
...
const z = { class: 'header' },
        ...
        return (
          ...
          b(
            ...
            { class: 'page-container' },
            {
              header: p(() => [
                t('div', z, [
                  t('span', null, _(d.title), 1),
                  t('div', E, [r(a.$slots, 'extra', {}, void 0, !0)])
                ])
              ]),
              default: p(() => [r(a.$slots, 'default', {}, void 0, !0)]),
              _: 3
            }
          )
        )
  ...
  A = S(I, [['__scopeId', 'data-v-989cafcb']])
export { A as _ }
